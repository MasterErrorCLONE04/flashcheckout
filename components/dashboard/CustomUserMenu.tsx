    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-[220px] p-3 bg-white border shadow-md rounded-lg z-50 flex flex-col gap-1 text-zinc-950">
        ...
        <div className="flex flex-col gap-1">
          <DropdownMenuItem asChild className="relative flex items-center gap-2 px-2 py-2 text-sm cursor-pointer rounded-lg text-zinc-500 transition-colors ease-in-out hover:text-zinc-900 hover:bg-zinc-100 focus:bg-zinc-100 focus:text-zinc-900 font-medium outline-none">
        ...
        <DropdownMenuItem 
          ...
          className="relative flex items-center gap-2 px-2 py-2 text-sm cursor-pointer rounded-lg text-red-600 transition-colors ease-in-out hover:text-red-700 hover:bg-red-50 focus:bg-red-50 focus:text-red-700 font-medium outline-none"
        >
