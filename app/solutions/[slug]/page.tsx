...
export async function generateMetadata(props: { params: Promise<{ slug: string }> }) {
  ...
  return {
    title: `${solution.title} — FlashCheckout`,
                ...
                <div className="bg-zinc-950 px-5 py-4 border-b border-zinc-800 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] font-medium text-emerald-400">En línea · FlashCheckout</p>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col gap-4 items-start max-w-3xl mb-12">
            ...
            <p className="text-base text-zinc-500 leading-relaxed font-normal">
              FlashCheckout potencia las ventas conversacionales proporcionando herramientas de automatización seguras y de alto impacto.
            </p>
          </div>
