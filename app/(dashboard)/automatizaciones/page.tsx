    ...
    <div className="space-y-6 pb-12 font-sans text-left">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-0.5">
          <h1 className="text-2xl font-bold tracking-tight text-zinc-950">Automatizaciones</h1>
          <p className="text-xs xl:text-sm font-semibold text-zinc-400">Activa y gestiona las automatizaciones de tu negocio.</p>
        </div>
                  ...
                  <div className="space-y-1.5 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 pt-0.5">
                      {item.channels.map((chan, idx) => (
                        ...
                        >
                          {chan === 'WhatsApp' ? (
                            <MessageSquare className="w-3 h-3 text-emerald-500 fill-current shrink-0" />
                          ) : (
